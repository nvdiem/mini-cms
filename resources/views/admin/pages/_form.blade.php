...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
  ...
  <div class="lg:col-span-4 space-y-6">
    ...
    <div class="card p-6">
      ...
      <input type="hidden" name="featured_image_id" id="featured_image_id" value="{{ old('featured_image_id', $page->featured_image_id) }}">

      <div id="featured_image_preview" class="mb-3">
        @if($page->featuredImage)
          <div class="relative group">
            <img src="{{ $page->featuredImage->url() }}" alt="{{ $page->featuredImage->alt_text }}" class="w-full h-auto rounded-lg border border-border-light dark:border-border-dark"/>
