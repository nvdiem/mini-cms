    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
      ...
      <div class="flex items-center gap-6">
        ...
        <div class="flex items-center gap-6 text-sm font-medium">
          ...
          <a href="{{ route('shop.index') }}" class="hidden sm:block text-slate-600 hover:text-primary transition">Shop</a>
          ...
          {{-- Cart Icon --}}
          <a href="{{ route('cart.index') }}" class="text-slate-600 hover:text-primary transition flex items-center gap-1" title="Cart">
